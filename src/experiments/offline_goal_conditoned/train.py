...
parser.add_argument('--hidden_size', type=int, nargs="+", default=[1024, 1024, 1024], metavar='N',
...
parser.add_argument('--traj_len', type=int, default=500, 
                    help='checkpoint training model every # steps')
parser.add_argument('--init_env_noise', type=float, default=1, 
                    help='checkpoint training model every # steps')
